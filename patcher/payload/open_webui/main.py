...
app.state.config.TWC_AUTH_CLIENT_ID = TWC_AUTH_CLIENT_ID
app.state.config.TWC_AUTH_CLIENT_SECRET = TWC_AUTH_CLIENT_SECRET
app.state.config.TWC_AUTH_SCOPE = TWC_AUTH_SCOPE
app.state.config.TWC_SAML_AUTHORIZE_URL = TWC_SAML_AUTHORIZE_URL
app.state.config.TWC_SAML_TOKEN_URL = TWC_SAML_TOKEN_URL
app.state.config.TWC_SAML_LOGIN_PATH = TWC_SAML_LOGIN_PATH
app.state.config.TWC_SAML_LOGIN_PORT = TWC_SAML_LOGIN_PORT
app.state.config.TWC_SAML_TOKEN_PATH = TWC_SAML_TOKEN_PATH
app.state.config.TWC_SAML_RETURN_URL_PARAMETER = TWC_SAML_RETURN_URL_PARAMETER
app.state.config.TWC_AUTH_SERVER_OVERRIDES = TWC_AUTH_SERVER_OVERRIDES
...
app.state.config.OPENID_END_SESSION_ENDPOINT = OPENID_END_SESSION_ENDPOINT
